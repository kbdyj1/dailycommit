...
int CMainFrame::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
	...
	m_wndStatusBar.SetPaneInfo(0, ID_SEPARATOR, SBPS_NORMAL, 64);
	m_wndStatusBar.SetPaneInfo(1, ID_SEPARATOR, SBPS_STRETCH, 64);
...
{
	BOOL result = m_wndStatusBar.SetPaneText(1, text);
	if (!result) {
		OutputDebugString(_T("SetPaneText(0) error\n"));
	}
	else {
